				...
				<div class="item-inform">
					<div class="clearfixLeft" id="clearcontent">
						...
						<div class="box">
							...
							<div class="tb-booth tb-pic tb-s310">
								<a href="/images/"><img src="/images/goods/{{ $good->gpic }}" alt="细节展示放大镜特效" rel="/images/goods/{{ $good->gpic }}" class="jqzoom" /></a>
							</div>
							<ul class="tb-thumb" id="thumblist">
								<li class="tb-selected">
									<div class="tb-pic tb-s40">
										<a href="#"><img src="/images/goods/{{ $good->gpic }}" mid="/images/goods/{{ $good->gpic }}" big="/images/goods/{{ $good->gpic }}"></a>
									</div>
								</li>
								<li>
									<div class="tb-pic tb-s40">
				 ...
				 {{$good->gname}}
						...
						<div class="tb-detail-list">
							...
							<div class="tb-detail-price">
								...
								<li class="price iteminfo_mktprice">
									<dt>原价</dt>
									<dd><em>¥</em><b class="sys_item_mktprice">1000</b></dd>									
								</li>
								<div class="clear"></div>
							</div>
										...
										<div class="theme-popbod dform">
											<form class="theme-signin" name="loginform" action="" method="post">
												...
												<div class="theme-signin-left">
													...
													<div class="theme-options kw">
														<div class="cart-title">口味</div>
														<ul>
															<li class="sku-line" value="原味" rel="1">原味<i></i></li>
															<li class="sku-line" value="奶油" rel="1">奶油<i></i></li>
															<li class="sku-line" value="炭烧" rel="1">炭烧<i></i></li>
															<li class="sku-line" value="咸香" rel="1">咸香<i></i></li>
														</ul>
													</div>
													<div class="theme-options pack">
														<div class="cart-title">包装</div>
														<ul>
															<li class="sku-line" value="裸装" rel="1">裸装<i></i></li>
															<li class="sku-line" value="全装" rel="2">全装<i></i></li>
															<li class="sku-line" rel="3">全家福礼包<i></i></li>
														</ul>
													</div>
													<div class="theme-options">
														...
														<dd>
															...
															<span id="Stock" class="tb-hidden">库存<span class="stock">{{$good->stock or 500}}</span>件</span>
														</dd>
						...
						<div class="pay">
							...
							<li>
								<div class="clearfix tb-btn tb-btn-basket theme-login gwc">
					...
					$('.pack ul li').click(function(){ //获取文本值
						s = $(this).attr('rel',1).text()
						console.log(s)
					})
					$('.kw ul li').click(function(){ //获取文本值
						z = $(this).attr('rel',1).text();
						console.log(z)
					})
					n = parseInt($('#text_box').val()); //将数量转换为整形
					$('#add').click(function(){ //判断+号点击
						n = (n+1)
					})
					$('#min').click(function(){ //判断-号点击
						n = (n-1);
					})
					$('.gwc').click(function(){ //发送ajax添加到购物车表 
						...
						$.ajax({
							...
							data:{'id':{{ $good->id }},'pack':s,'eat':z,'num':n},
