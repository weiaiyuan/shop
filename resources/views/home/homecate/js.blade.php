...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="nav white">
			...
			<div class="logoBig">
				<li><img src="/static/home/images/logobig.png" style="width: 140px;height: 90px" /></li>
			</div>
		...
		<div class="concent">
			...
			<div class="paycont">
               ...
               <span class="buy-user">{{$v->username}} </span>
									<span class="buy-phone">{{$v->userphone}}</span>
									</span>
								</div>
							   ...
							   <span class="province">{{$v->province}}</span>
									<span class="city">{{$v->country}}</span>
								...
								<div class="bundle-main">
									<ul class="item-content clearfix">
										<div class="pay-phone">
											<li class="td td-item">
												<div class="item-pic">
													<a href="#" class="J_MakePoint">
														<img src="/images/goods/{{$v->gpic}}" style="width: 100px;height: 100px;"></a>
												</div>
												<div class="item-info">
											...
											<li class="td td-info" ">
												<div class="item-props" style="text-align: center;>
													<span class="sku-line">颜色：{{$v->color}}</span>
													<span class="sku-line">包装：{{$v->order->pack}}</span>
												</div>
											</li>
											...
											<div class="amount-wrapper ">
												<div class="item-amount ">
													...
													<div class="sl">
														...
														<input class="text_box" name="" type="text" value="{{$v->order->rec}}" style="width:30px;" />
														<input class="add am-btn" name="" type="button" value="+" />
													</div>
												</div>
											</div>
										</li>
										<li class="td td-sum dj">
											<div class="td-inner">
												<em tabindex="0" class="J_ItemSum number">{{$v->order->sum}}</em>
											</div>
										</li>
				...
				<!--优惠券 -->
						...
						<!--含运费小计 -->
						<div class="buy-point-discharge hj">
						...
						<div class="order-go clearfix">
							<div class="pay-confirm clearfix">
                                ...
                                <span>¥</span> <em class="style-large-bold-red sfk" id="J_ActualFee">244.00</em>
										</span>
									</div>
							   ...
							   <span class="province">湖北</span>省
								...
								<div id="holyshit269" class="submitOrder">
									<div class="go-btn-wrap">
										<a id="" href="/home/js/update" class="btn-go" tabindex="0" title="点击此按钮，提交订单">提交订单</a>
									</div>
								</div>
								<div class="clear"></div>
							</div>
		...
		<div class="theme-popover">
			...
			<script type="text/javascript">
					...
					$('.add').each(function(){
						$(this).click(function(){
							x = parseInt($(this).parent().parent().parent().parent().prev().find('.td-price').text());
