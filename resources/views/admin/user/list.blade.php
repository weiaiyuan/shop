...
<<<<<<< HEAD
					<div class="box-header">
						<h2><i class="halflings-icon white align-justify"></i><span class="break"></span>用户列表</h2>
						<div class="box-icon">
      ...
      <tbody role="alert" aria-live="polite" aria-relevant="all">
        ...
        <tr class="odd">
          ...
          <td class="center ">
            ...
            <form action="/admin/user/{{$v->id}}" method="post" style="display: inline;">{{ csrf_field() }} {{ method_field('DELETE') }}
              <input type="submit" class="btn btn-danger" value="删除"></form></td>
        </tr>@endforeach</tbody>
    </table>
  </div>
  <div class="pagination pagination-centered">{!! $data->render() !!}</div></div>
>>>>>>> origin/zcz
