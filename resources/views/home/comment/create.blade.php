					...
					<div class="am-container header">
						...
						<ul class="message-r">
							...
							<div class="topMessage mini-cart">
								<div class="menu-hd"><a id="mc-menu-hd" href="/home/" target="_top"><i class="am-icon-shopping-cart  am-icon-fw"></i><span>购物车</span><strong id="J_MiniCartNum" class="h">0</strong></a></div>
							</div>
				...
				<div class="main-wrap">
						...
						<div class="comment-main">
							<div class="comment-list">
								...
								<div class="item-comment">
									<textarea placeholder="请写下对宝贝的感受吧，对他人帮助很大哦！" class="contents sd"></textarea>
								</div>
								<div class="item-opinion">
									<li rel="1" ><i class="op1" ></i>好评</li>
									<li rel="2"><i class="op2" ></i>中评</li>
									<li rel="3"><i class="op3" ></i>差评</li>
								</div>
							</div>						
					...
					<script type="text/javascript">
						...
						$('.am-btn-danger').click(function(){
							var s=$('.contents').val();
							$.ajax({'url':'/home/comment/store',	//发送ajax
									type:'get',			//get方式
									async:false,	//异步
									data:{'hp':ii,'content':s,'id':{{ $data->id }}},	//数据传入
