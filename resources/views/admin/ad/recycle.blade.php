...
<div class="box span12">
	<div class="box-header" data-original-title="">
		<h2><i class="halflings-icon white user"></i><span class="break"></span>广告回收站</h2>
		<div class="box-icon">
				...
				<table class="table table-striped table-bordered bootstrap-datatable text-center" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info" >
					...
					@foreach($data as $k=>$v)
						<tr>
							...
							<td>{{ $v->end }}</td>
							<td>
								<a href="/admin/restores/{{ $v->id }}" class="btn btn-warning">恢复数据</a>
								<a href="/admin/del/{{ $v->id }}" class="btn btn-danger">彻底删除</a>	
							</td>
						</tr>
					@endforeach
