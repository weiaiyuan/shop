    ...
    <div class="login-box"> 
     <div class="am-tabs" id="doc-my-tabs"> 
      <ul class="am-tabs-nav am-nav am-nav-tabs am-nav-justify"> 
       <li class="am-active"> <a href="/h/"> 邮箱注册 </a> </li> 
       <li> <a href="/h/"> 手机号注册 </a> </li> 
      </ul> 
       ...
       <div class="am-tab-panel"> 
        ...
        <form method="post"> 
         ...
         <div class="verification"> 
          ...
          <a class="btn" href="/h/javascript:void(0);" onclick="sendMobileCode();" id="sendMobileCode"> <span id="dyMobileButton"> 获取 </span> </a> 
         </div> 
         <div class="user-pass"> 
          <label for="password"> <i class="am-icon-lock"> </i> </label> 
