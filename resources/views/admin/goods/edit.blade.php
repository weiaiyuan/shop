					...
					<div class="box-content">
						...
						{{ method_field('PUT')}}
						  ...
						  <div class="control-group">
							  ...
							  <div class="controls">
								<input type="file" class="input-xlarge datepicker hasDatepicker" id="date01" value="" name="gpic"><span><img src="/Admin/goods/{{ $data->gpic}}" style="width: 100px;height: 100px;"></span>
							  </div>
							</div>
