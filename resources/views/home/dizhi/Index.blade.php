							...
							<li class="user-addresslist defaultAddr">
								...
								<div class="new-mu_l2a new-p-re">
									<p class="new-mu_l2cw">
										...
										<span class="city">{{$v->country}}</span>市
										<span class="dist">{{$v->town}}</span>区
										<span class="street">{{$v->address}}</span></p>
								</div>
								<div class="new-addr-btn">
									<a href="/home/dizhi/edit/{{$v->id}}"><i class="am-icon-edit"></i>编辑</a>
									<span class="new-addr-bar">|</span>
									<a href="/home/dizhi/del/{{$v->id}}" onClick="delClick(this);"><i class="am-icon-trash"></i>删除</a>
								</div>
							</li>
                                 @endforeach
						...
						<div class="am-modal am-modal-no-btn" id="doc-modal-1">
							...
							<div class="add-dress">
								...
								<div class="am-u-md-12 am-u-lg-8" style="margin-top: 20px;">
									<form class="am-form am-form-horizontal" action="/home/dizhi/create" method="post">
                                        {{ csrf_field() }}
				...
				<ul>
					...
					<li class="person">
						...
						<ul>
							...
							<li class="active"> <a href="/home/dizhi/index">收货地址</a></li>
						</ul>
					</li>
					<li class="person">
						<a href="#">我的交易</a>
