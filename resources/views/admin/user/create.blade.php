						...
						<form class="form-horizontal" method="post" action="/admin/user">
						  ...
						  <fieldset>
							<div class="control-group">
							  ...
							  <div class="controls">
								<input class="span6 typeahead" id="typeahead" data-provide="typeahead" data-items="4"  type="text" name="user">
							  </div><br>
							  ...
							  <div class="controls">
								<input class="span6 typeahead" id="typeahead" data-provide="typeahead" data-items="4"  type="text" name="qpass">
							  </div><br>
                              ...
                              <div class="control-group">
								...
								<div class="controls">
								  ...
								  <label class="radio">
									<input type="radio" name="sex" id="optionsRadios2" value="3">
									保密
								  </label>
								</div>
							  </div>
