					...
					<div class="am-container header">
						<ul class="message-l">
							<div class="topMessage">
								<div class="menu-hd">
									<a href="/home/login/index" target="_top" class="h">{{session('username')}}</a>
						...
						<div class="am-modal am-modal-no-btn" id="doc-modal-1">
							...
							<div class="add-dress">
								...
								<div class="am-u-md-12 am-u-lg-8" style="margin-top: 20px;">
									<form class="am-form am-form-horizontal" action="/home/dizhi/update/{{$dizhi->id}}" method="post">
                                        {{ csrf_field() }}
										<div class="am-form-group">
											<label for="user-name" class="am-form-label">收货人</label>
											<div class="am-form-content">
												<input type="text" id="user-name" placeholder="收货人" name="username" value="{{$dizhi->username}}">
											</div>
										</div>
										...
										<div class="am-form-group">
											...
											<div class="am-form-content">
												<input id="user-phone" placeholder="手机号必填" type="text" name="userphone" value="{{$dizhi->userphone}}">
											</div>
										</div>
								     
								        <div class="am-form-group">
								        	<label for="user-phone" class="am-form-label">请选择</label>
								         <select id="Province" runat="server" name="province"  style="width: 90px; float:left;" ></select>
										       <select id="Country" runat="server" name="country" style="width: 90px;float:left;"></select>
												<select id="Town" runat="server" name="town"  style="width: 90px;float:left;"></select><br>
									      </div>
										...
										<div class="am-form-group">
											...
											<div class="am-form-content">
												<textarea class="" rows="3" id="user-intro" placeholder="输入详细地址" name="address" >{{$dizhi->address}}</textarea>
