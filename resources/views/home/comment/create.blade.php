				...
				<div class="main-wrap">
						...
						<div class="comment-main">
							<div class="comment-list">
								...
								<div class="item-comment">
									<textarea placeholder="请写下对宝贝的感受吧，对他人帮助很大哦！" class="contents"></textarea>
								</div>
					...
					<script type="text/javascript">
						...
						$('.am-btn-danger').click(function(){
							var s=$('.contents').val();
							$.get('/home/comment/store',{'hp':ii,'content':s,'gid':{{ $data->id }}},function(msg){
								if(msg=='success'){
									alert('发表成功');
				...
				<ul>
					...
					<li class="person">
						...
						<ul>
							...
							<li class="active"> <a href="/home/comment/index">评价</a></li>
